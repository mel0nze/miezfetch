...
printf "${CYAN}         dGGGGMMb          ${RESET}  ${CYAN}OS:${RESET}      $OS $ARCH\n"
printf "${CYAN}        @p~qp~~qMb         ${RESET}  ${CYAN}Kernel:${RESET}  $KERNEL\n"
printf "${CYAN}        M|@||@) M|         ${RESET}  ${CYAN}Uptime:${RESET}  $UPTIME\n"
printf "${CYAN}        @,----.JM|         ${RESET}  ${CYAN}Shell:${RESET}   $SHELL\n"
printf "${CYAN}       JS^\\__/  qKL        ${RESET}  ${CYAN}CPU:${RESET}     $CPU\n"
printf "${CYAN}      dZP        qKRb      ${RESET}  ${CYAN}RAM:${RESET}     $RAM\n"
printf "${CYAN}     dZP          qKKb     ${RESET}  ${CYAN}GPU:${RESET}     $GPU\n"
printf "${CYAN}    fZP            SMMb    ${RESET}  ${CYAN}Date:${RESET}    $DATE\n"
